...
**Project**: interactive-gantt-slider 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: Please try to create an interactive Animation experience with this Gant Chart Template. There should be a vertical slider at the left corner that controls the the bar percentage of each progressbar indirectly with a different multiplier for each and 100% as the maximum for each progressbar.  
...
```sh
git clone https://github.com/GPT-Engineer-App/interactive-gantt-slider.git
cd interactive-gantt-slider
npm i
